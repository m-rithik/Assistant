  ...
  async function checkSession() {
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        console.error("Non-JSON response from session check:", text);
        return;
      }
  ...
  async function handleLogin(e) {
    ...
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        ...
        // If not JSON, get text response
        const text = await res.text();
        console.error("Non-JSON response from VTOP login:", text);
            ...
            {isLoggedIn ? (
              ...
              <form onSubmit={handleLogin} className="vtop-login-form">
                <div className="vtop-form-group">
                  <label htmlFor="vtop-username">Registration Number</label>
                  <input
                    id="vtop-username"
                    type="text"
                    value={username}
